...
<body class="bg-light">
    ...
    <div class="card bg-white shadow mt-4 w-50 mx-auto p-4 rounded">
        <h5>Tambah Order</h5>
        <span class="fs-15 mb-3">Tambah order laundry</span>
        <form action="{{ route('doOrder') }}" method="post">
            @csrf
            <div class="form-group mt-1">
                <label class="fs-15">Kode Pesanan</label>
                <input type="text" name="kode_pesanan" class="form-control form-sm" disabled value="{{ $kode }}">
            </div>
            <div class="form-group mt-1">
            ...
            <div class="form-group mt-1">
                ...
                <input type="date" name="tgl_pesan" class="form-control form-sm" value="{{ $tgl }}">
            </div>
            <div class="form-group mt-1">
            ...
            <div class="form-group mt-1">
                <label class="fs-15">Satuan <i>*kg</i></label>
                <input type="number" name="qty" class="form-control form-sm">
            </div>
            <button type="submit" class="btn btn-sm btn-success fs-15 mt-3 float-end"><i class="bi-floppy"></i> Simpan</button>
        </form>
    </div>
