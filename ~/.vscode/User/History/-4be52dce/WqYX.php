...
Route::get('/kasir/order/tambahorder/hapusOrder', [App\Http\Controllers\layananController::class, 'hapusorder'])->name('hapusOrder');
Route::get('/kasir/order/hapis/{?id}', [App\Http\Controllers\layananController::class, 'hapusorder'])->name('hapusOrder');