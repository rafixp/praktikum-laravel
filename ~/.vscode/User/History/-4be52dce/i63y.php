...
Route::get('/kasir/home/', [App\Http\Controllers\layananController::class, 'home'])->name('kasirHome');
Route::get('/kasir/order/', [App\Http\Controllers\layananController::class, 'order'])->name('kasirOrder');
